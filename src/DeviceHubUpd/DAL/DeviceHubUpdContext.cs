...
namespace DeviceHubUpd.DAL;

public partial class DeviceHubUpdContext : DbContext
{
    public DeviceHubUpdContext()
    {
    }

    public DeviceHubUpdContext(DbContextOptions<DeviceHubUpdContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserName, "UQ__Account__C9F28456E4E1DBBD").IsUnique();
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F690DB5541").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E7170A497B2").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E38BCE1905B").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D1053493042007").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F6F8BDFD01").IsUnique();
        ...
        modelBuilder.Entity<Role>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Role__737584F65B786D91").IsUnique();
